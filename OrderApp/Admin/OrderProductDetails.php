...
<header>
	...
	if (!isset($_SESSION['email'])) {
		...
		auth/authentication2.php'>Register</a>";
			}
	else{
...
<?php 
		...
		if ($conn) {
			...
			$sqlp = "SELECT * FROM OrderProducts WHERE id = '".$_POST['id']."'";
			...
			if ($result->num_rows > 0) {
					...
					$img = "uploads/".$row['image']."";
				   	...
				   	echo "<div>";
				   	echo "Name: " . $row["name"]. "<br />Prix: " . $row["prix"]. "<br /> Description: " . $row["description"]. "<br>";
//				   	if ($_SESSION['admin'] != 1)
//				   	{
