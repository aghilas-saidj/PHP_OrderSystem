...
if ($conn) {
...

			{
				   while($row = $result->fetch_assoc()) 
				   {
					...
					//   echo "<h3>REPORT : </h3>";
					   echo "<h3>Total Maked : RM ".$makedCake[0]."</h3>";
					   echo "<a class='btn' href='Show_details.php'>Show Details</a>";
					echo "</div>";
...

			{
				   while($row = $result->fetch_assoc()) 
				   {
				   	...
				   	if ($row['served'] == '1') {
	                        ...
	                        $makedCustomizedCake[0] = $makedCustomizedCake[0] + $row['prix'];
	                        
	                        array_push($makedCustomizedCake , $row['prix']);
				   ...
				   echo "<h3>Total Maked : RM ".$makedCustomizedCake[0]."</h3>";
				   echo "<a class='btn' href='Show_details.php'>Show Details</a>";
				   echo "</div>";
