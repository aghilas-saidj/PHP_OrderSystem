...

			{
				   while($row = $result->fetch_assoc()) 
				   {
					 ...
					 //  	echo "<div class='grid-container'>";
   				   	...
   				   	//		echo "<form action='confirme_order.php' method='POST'>";
					  // 		echo "<input type='hidden' name='id' value = ".$row["id"].">";
					   	//	echo "<button>Confirme</button>";
					   	//	echo "</form>";	
			  ...
			  // 		echo "<form action='confirme_order.php' method='POST'>";
			   	//	echo "<input type='hidden' name='id' value = ".$row["id"].">";
			   	//	echo "<button class = 'pay'>Confirme</button>";
			   	//	echo "</form>";	
 					...
 					//   	$img = "uploads/".$row['image']."";
					  ...
					  // 	echo "<img src='".$img."' width='50%' height='60%' />";
					   	...
					   	echo "<br />";
						   	...
						   	if ($row['prix'] != '0' && $row['confirmed']=='1' && $row['served'] != '0') {

						   	    echo"Type : " . $row["type"]. " <br /> Description : " . $row["description"]. " <br>";
						   	    echo "<p>Served</p>";
					   	    }

					   	    elseif ($row['prix'] != '0' && $row['confirmed']=='1' && $row['served'] == '0') {
					   	    echo"Type : " . $row["type"]. " <br /> Description : " . $row["description"]. " <br>";
					   	    echo "<p>No Served</p>";	
					   	    }
					   	    else
